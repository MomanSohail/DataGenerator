...
def main(r2_r3, no_of_paths, Flag, format, no_of_env, Flag_tf, no_of_obstacles, size_of_obstacles, rn):
    ...
    for x in range(1, no_of_env + 1):
        ...
        if r2_r3 == "r3":
            obstaclescontrols = [random.random(), random.random(), random.random(), random.random(), random.random(),
            ...
            if a == 1:
                ...
                obstaclescontrols = [random.random(), random.random(), random.random(), random.random(),
                ...
                if kautham.kSetQuery(init, goal):
                    ...
                    if path:
                        if Flag_tf:
                            ...
                            tfile_init = 'z_initialANDgoal_states/initial_goal_states' + str(
                                x) + "/init_goal_" + Name_2 + str(c) + format
                        ...
                        if Flag_tf:
                            writeTaskfile(path, str(x) + "_" + kauthamproblem, Flag, r2_r3, file_name_counter,
                                          format, folder_number)
                        if Flag:
                            if not Flag_tf:
